...
<html lang="en">
  ...
  <body>
    ...
    <div class="blog-masthead">
        <div class="container">
            <nav class="blog-nav">
                ...
                <a href="report.php" class="blog-nav-item active">Reporte de servicios</a>
    ...
    <div class="container">
          <h2 class="blog-post-title">Reporte de servicios</h2>
          ...
          <table class="table table-striped">
             ...
             <?php foreach($oService->report() as $ser): ?>
              <tr>
                  <td><?php echo $ser['name']; ?></td>
                  <td><?php echo $ser['date']; ?></td>
                  <td><span class="badge"><?php echo $ser['total']; ?></span></td>
              </tr>
              <?php endforeach; ?> 
          </table>          
